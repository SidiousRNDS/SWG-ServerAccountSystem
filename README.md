...
This is the updated version of the system that is currently running on http://clientaccess.swgrogueone.com.
...
ip has been used mpreviously and if they have more the the allowed times it will not create the account).
