...
class adminuserController extends baseController
{
    ...
    /**
     * @method adminCreateUserView - Display the User Create Form
    ...
    /**
     * @method adminCreateUserAction - Add new helper to the DB
     * @param ServerRequestInterface $request
     * @param ResponseInterface $response
     * @return mixed
    ...
    /**
     * @method adminUpdateUserView - Update helper form display
     * @param ServerRequestInterface $request
     * @param ResponseInterface $response
     * @return mixed
     * @throws \Exception
    ...
    /**
     * @method adminDeleteUsersAction - Remove User from the DB
     * @param ServerRequestInterface $request
     * @param ResponseInterface $response
     * @return mixed
     */
