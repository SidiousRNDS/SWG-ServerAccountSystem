...
class security
{
    ...
    /**
     * @method removeLockTracking
     * Unset the tracking session and flash messages
     * @param array $args
     */
    ...
    /**
     * @method removeSessionLockTracking
     */
    ...
    /**
     * @method addLockMessage
     * Add lock message to the Flash Message System
     * @param array $args
     * @param $msg
     */
    ...
    /**
     * @method loggedInUserRole
     * Get the perms for the helper that is logged in
     * @param array $args
     * @return mixed
     */
